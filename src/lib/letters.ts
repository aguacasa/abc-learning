...
export const letters: Letter[] = [
  ...
  { id: 'E', display: 'E', back: 'E', word: 'Elephant', sound: 'E is for Elephant' },
  { id: 'F', display: 'F', back: 'F', word: 'Fish', sound: 'F is for Fish' },
  { id: 'G', display: 'G', back: 'G', word: 'Guitar', sound: 'G is for Guitar' },
  ...
  { id: 'O', display: 'O', back: 'O', word: 'Octopus', sound: 'O is for Octopus' },
  { id: 'P', display: 'P', back: 'P', word: 'Pig', sound: 'P is for Pig' },
  { id: 'Q', display: 'Q', back: 'Q', word: 'Queen', sound: 'Q is for Queen' },
  { id: 'R', display: 'R', back: 'R', word: 'Rainbow', sound: 'R is for Rainbow' },
  { id: 'S', display: 'S', back: 'S', word: 'Sun', sound: 'S is for Sun' },
  { id: 'T', display: 'T', back: 'T', word: 'Turtle', sound: 'T is for Turtle' },
  { id: 'U', display: 'U', back: 'U', word: 'Umbrella', sound: 'U is for Umbrella' },
  { id: 'V', display: 'V', back: 'V', word: 'Violin', sound: 'V is for Violin' },
